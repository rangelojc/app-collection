...
const ThemeToggleSwitch = () => {
  ...
  return (
    <Switch.Root
      ...
      className={cn(
        "fixed top-3 right-4 z-10 inline-flex h-6 w-10 flex-none cursor-pointer items-center rounded bg-gray-200 transition-colors data-[state=checked]:bg-neutral-600"
      )}
    >
      <Switch.Thumb
        className={cn(
